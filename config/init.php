...
if (!defined('YII_DEBUG')) {
    define('YII_DEBUG', $env === 'dev' || 1);
    //define('YII_DEBUG', $env === 'dev');
}

// Читаем общий конфиг
$config = require_once(__DIR__ . '/' . 'common.php');
// Добиваем его конфигом от типа подключения(console, web)
$config = array_merge_recursive($config, require_once(__DIR__ . '/' . $setting['type'] . '.php'));
